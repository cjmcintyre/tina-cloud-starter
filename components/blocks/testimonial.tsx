    ...
    <Section color={data.color}>
      <Container size="large">
        <blockquote>
          ...
          >
            <span
              className={`block opacity-15 text-5xl absolute inset-y-1/3 transform translate-y-1	-left-8 leading-4 -z-1`}
            >
              &ldquo;
            </span>
            ...
            <span
              className={`block opacity-15 text-6xl absolute inset-y-1/3 transform translate-y-3	-right-8 leading-4 -z-1`}
            >
              &rdquo;
            </span>
          </div>
